...
3. **Botón de envío** centrado al final de la **última semana de cada avance**
   ...
   > esqueleto de ejemplo. El esqueleto muestra solo 3 semanas de muestra; en un
   > curso real el Avance 1 puede abarcar 4, 5 o más semanas. **El botón va en la
   ...
   > envío. **NUNCA copies el número "3" del esqueleto literalmente.**
